...
plt.title('CIs at 68% CL', loc='left')
plt.title(f'$\\beta=${beta}', loc='right')
plt.xlim(1.35, 1.65)
plt.xlabel('$\\mu$')
plt.legend()
plt.yticks([])
plt.savefig('Test_results/ExtendedKFC/Condor_Confidence_intervals_CL_68.png')
plt.close()
...
plt.legend()
plt.yticks([])
plt.savefig('Test_results/ExtendedKFC/Sorted_CIs_CL_60.png')
plt.close()
