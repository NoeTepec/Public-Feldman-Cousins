...
with open('Preliminary_data/CIs.txt', 'r') as file:
    for line in file:
...
plt.vlines(0, 0, height, color='red', linestyle='--', label='Boundary')
...
plt.yticks([])
#plt.grid()
plt.savefig('Preliminary_data/Condor_CIs_CL_90.png')
plt.close()
...
plt.legend()
plt.yticks([])
plt.savefig('Preliminary_data/Condor_Sorted_CIs_CL_90.png')
plt.close()
